...
def process_song_file(cur, filepath):
    ...
    print(f"file {filepath} read done.")

    song_data = df[['song_id', 'title', 'artist_id', 'year', 'duration']].values.tolist()[0]
    cur.execute(song_table_insert, song_data)
    print("insert song record done.")
    ...
    print("insert artist record done.")
...
def process_data(cur, conn, filepath, func):
    """
    files processing: each file is processed either with function process_song_file or process_log_file
    """
